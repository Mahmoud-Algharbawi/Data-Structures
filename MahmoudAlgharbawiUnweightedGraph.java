...
@SuppressWarnings("unchecked")
 ...
 public class MahmoudAlgharbawiUnweightedGraph<V> implements MahmoudAlgharbawiGraph<V> {
    protected List<V> vertices = new ArrayList<>(); // Store vertices
    protected List<List<Edge>> neighbors = new ArrayList<>(); // Adjacency Edge lists

    /** Construct an empty graph */
    protected MahmoudAlgharbawiUnweightedGraph() {
    }

    /** Construct a graph from vertices and edges stored in arrays */
    protected MahmoudAlgharbawiUnweightedGraph(V[] vertices, int[][] edges) {
    ...
    protected MahmoudAlgharbawiUnweightedGraph(List<V> vertices, List<Edge> edges) {
    ...
    protected MahmoudAlgharbawiUnweightedGraph(List<Edge> edges, int numberOfVertices) {
    ...
    protected MahmoudAlgharbawiUnweightedGraph(int[][] edges, int numberOfVertices) {
        for (int i = 0; i < numberOfVertices; i++)
            addVertex((V)(Integer.valueOf(i))); // vertices is {0, 1, . . . }
