...
public class MahmoudAlgharbawiAVLTree<E> extends MahmoudAlgharbawiBinarySearchTree<E> {
    /** Create an empty AVL tree using a natural comparator*/
    public MahmoudAlgharbawiAVLTree() { // super() is implicitly called
    }
    /** Create a BST with a specified comparator */
    public MahmoudAlgharbawiAVLTree(java.util.Comparator<E> c) {
        super(c);
    }

    /** Create an AVL tree from an array of objects */
    public MahmoudAlgharbawiAVLTree(E[] objects) {
        super(objects);
    }
    ...
    * Return false if the element is not in the tree */
    ...
    protected static class AVLTreeNode<E> extends MahmoudAlgharbawiBinarySearchTree.TreeNode<E> {
