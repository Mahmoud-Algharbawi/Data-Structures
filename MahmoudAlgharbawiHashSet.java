...
@SuppressWarnings("unchecked")
 ...
 public class MahmoudAlgharbawiHashSet<E> implements Collection<E> {
    ...
    public MahmoudAlgharbawiHashSet() {
        this(DEFAULT_INITIAL_CAPACITY, DEFAULT_MAX_LOAD_FACTOR);
    }

    /** Construct a set with the specified initial capacity and
    * default load factor */
    public MahmoudAlgharbawiHashSet(int initialCapacity) {
        this(initialCapacity, DEFAULT_MAX_LOAD_FACTOR);
    }

    /** Construct a set with the specified initial capacity
    * and load factor */
    public MahmoudAlgharbawiHashSet(int initialCapacity, float loadFactorThreshold) {
    ...
    public java.util.Iterator<E> iterator() {
        return new MahmoudAlgharbawiHashSetIterator(this);
    }

    /** Inner class for iterator */
    private class MahmoudAlgharbawiHashSetIterator implements java.util.Iterator<E> {
        // Store the elements in a list
        private java.util.ArrayList<E> list;
        private int current = 0; // Point to the current element in list
        private MahmoudAlgharbawiHashSet<E> set;

        /** Create a list from the set */
        public MahmoudAlgharbawiHashSetIterator(MahmoudAlgharbawiHashSet<E> set) {
            this.set = set;
            list = setToList();
        }
